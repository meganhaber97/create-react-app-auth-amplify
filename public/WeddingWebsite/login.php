...
<body>
	...
	<div class="bgimg-1 w3-display-container w3-opacity-min w3-center">
      ...
      <h2 class="w3-center w3-animate-opacity sectionTitle w3-hide-small" style="font-family:lemon-brush; margin-bottom:-50px; margin-top:-40px; color: white; text-shadow: 2px 2px black;">Access the Wedding Details</h2>
      <?php echo $error; ?>
